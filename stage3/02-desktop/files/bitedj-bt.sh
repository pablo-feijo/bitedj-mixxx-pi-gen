...
SELECTION=$(echo -e "PAIR_NEW\n+ Pair New Device...\n$DEVICES" | zenity --list --title="Bluetooth" --text="Tap your headphones to connect:" --column="MAC" --column="Name" --hide-column=1 --width=600 --height=400)
