...
working file was subsequently shrunk. `scripts/test/git-size-exceptions.json`
pins inherited test fixtures by exact path and blob ID; do not add exceptions for
new assets. Changing an inherited large fixture requires LFS or a smaller fixture.
